...
//      */
//     static kio::Task<kio::Result<std::unique_ptr<Partition>>> Open(const BitcaskConfig& config, kio::IoContext& ctx,
//                                                                    size_t partition_id);
//
//     // ctor/dtor
//     Partition(const BitcaskConfig& config, kio::IoContext& ctx, size_t partition_id);
